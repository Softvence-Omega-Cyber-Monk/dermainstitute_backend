...
export class ReportController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns a list of all reports with optional filtering and search.',
  })
  ...
  @ApiQuery({
    ...
    type: String,
    description:
      'Search for reports by incident title using a partial, case-insensitive match.',
  })
  async findAll(
    @Query('situation') situation?: Situation,
  ...
  async findOne(@Param('id') id: string) {
    try {
      ...
      throw new InternalServerErrorException(
        'Failed to retrieve the incident report.',
      );
    }
  }
  ...
  async update(
    ...
    try {
      ...
      throw new InternalServerErrorException(
        'Failed to update the incident report.',
      );
    }
  }
  ...
  async remove(@Param('id') id: string) {
    try {
      ...
      throw new InternalServerErrorException(
        'Failed to delete the incident report.',
      );
    }
  }
}
